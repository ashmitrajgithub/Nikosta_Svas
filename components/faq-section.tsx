    ...
    <section className="py-4 px-4 bg-gradient-to-br from-slate-50 via-white to-emerald-50/30 relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 leading-[1.1] tracking-tight">
            Everything You
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed font-medium">
            Get instant answers to common questions about our wellness services and personalized yoga programs.
          </p>
        </div>
